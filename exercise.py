...
def apply_discount(price, discount):
    ...
    discount_subtract = price * decimal_discount
    new_price = price - discount_subtract
    return(new_price)
...
def convert_temperature(degrees, units):
    if "C" in units:
...
def calculate_tip(bill_amount, tip_percentage):
    ...
    tip_subtract = bill_amount * decimal_tip
    real_tip = tip_subtract
    return(real_tip)
